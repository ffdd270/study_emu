...
void ImGui::TreePop()
{
    ...
    IM_ASSERT(window->IDStack.Size > 1); // There should always be 1 cpu in the IDStack (pushed during window creation). If this triggers you called TreePop/PopID too much.
    PopID();
}
