...
{
	std::string comment = createComment_Registers( "OR", GetOpCodeSecondValue( opCode ), GetOpCodeThirdValue( opCode) );
...
{
	std::string comment = createComment_Registers( "AND", GetOpCodeSecondValue( opCode ), GetOpCodeThirdValue( opCode ) );
	pushDisASMString(opCodeToDisASMString(opCode, comment));
}
...
{
	std::string comment = createComment_Registers( "XOR", GetOpCodeSecondValue( opCode ), GetOpCodeThirdValue( opCode) );
	pushDisASMString(opCodeToDisASMString(opCode, comment));
}
...
{
	std::string comment = createComment_Registers( "SHR", GetOpCodeSecondValue( opCode ), GetOpCodeThirdValue( opCode) );
	pushDisASMString(opCodeToDisASMString(opCode, comment));
}
...
{
	std::string comment = createComment_Registers( "SHL", GetOpCodeSecondValue( opCode ), GetOpCodeThirdValue( opCode) );
	pushDisASMString(opCodeToDisASMString(opCode, comment));
}
